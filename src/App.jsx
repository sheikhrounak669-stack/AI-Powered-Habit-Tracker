...
export default function App() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 bg-linear-to-b from-slate-900 to-black pt-24 pb-10 px-4 font-sans text-slate-200 flex flex-col items-center relative selection:bg-emerald-500/30">
